---
title: "How I Created `get_ensemble_files.R` To Import ProsodyPro Ensemble Output Into R"
...
## Introduction
This document describes how I went about creating an R script, `get_ensemble_files.R`, which imports aggregate ("ensemble") calculation output files from the [ProsodyPro] (http://www.homepages.ucl.ac.uk/~uclyyix/ProsodyPro/) Praat script developed by Yi Xu (See [README.md] (https://github.com/klp3hills/prosodypro-R.git)).
...
## The `get_ensemble_files.R` script will...
...
To execute the `get_ensemble_files.R`:
