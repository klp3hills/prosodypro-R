...
for (i in 1:nrow(melody.list)) { 
  dat[dat$mix==melody.list[i,]$noun,]$mix <- melody.list[i,]$mix
  dat[dat$mel==melody.list[i,]$noun,]$mel <- melody.list[i,]$mel
  dat[dat$ipa==melody.list[i,]$noun,]$ipa <- melody.list[i,]$ipa
  dat[dat$cv==melody.list[i,]$noun,]$cv <- melody.list[i,]$cv
}
```
